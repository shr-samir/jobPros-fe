...
const Navbar = () => {
  ...
  return (
    <nav className="bg-mainColor w-full">
      <div className="max-w-7xl m-auto flex justify-between items-center px-5 gap-8 text-white">
        <Link to="/">
          <img
            src={assets.logo}
            alt="JobPros Logo"
        ...
        <ul className="hidden md:flex gap-4 lg:gap-12">
          ...
          <li>
            <NavLink to="/jobs" className="flex flex-col items-center justify-center">
              <p>All Jobs</p>
              <hr className="w-1/2 h-[1.5px] bg-white border-none hidden" />
            </NavLink>
          </li>
