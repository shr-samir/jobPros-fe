...
const JobCategory = ({name, totalJobs, icon}) => {
  return (
    <div className='w-[290px] h-[84px] bg-white hover:bg-hoverColor shadow-boxShadow rounded-md hover:border border-mainColor flex items-start justify-start gap-5 p-4 cursor-pointer'>
